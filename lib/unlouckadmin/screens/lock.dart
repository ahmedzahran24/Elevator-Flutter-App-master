...
class lockadmin extends StatefulWidget {
  const lockadmin({super.key});

  @override
  State<lockadmin> createState() => _lockadminState();
}

class _lockadminState extends State<lockadmin>
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 17), () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const GetStartedadmin()),
      );
    });
