...
class GetStartedadmin extends StatefulWidget {
  const GetStartedadmin({super.key});

  @override
  State<GetStartedadmin> createState() => _GetStartedadminState();
}

class _GetStartedadminState extends State<GetStartedadmin>
                  ...
                  child: SlideAction(
                    ...
                    onSubmit: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const lockadmin()),
                      );
                    },
